...
public interface ItemHandler<T> {
    ...
    default void load(@NotNull GuiDataLoader<?> loader, @NotNull GuiItemController controller, @NotNull HandlerContext<HumanEntity> context) {
        load(((T) loader), controller, context);
    }

    void load(@NotNull T loader, @NotNull GuiItemController controller, @NotNull HandlerContext<HumanEntity> context);
}
