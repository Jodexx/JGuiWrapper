...
import com.jodexindustries.jguiwrapper.NMSMatcher;
...
public abstract class AbstractGui {
    ...
    private static final NMSWrapper NMS_WRAPPER = NMSMatcher.getWrapper();
    ...
    public final void updateTitle(@NotNull HumanEntity player, @NotNull Component title) {
        NMS_WRAPPER.updateTitle(player, title);
    }
